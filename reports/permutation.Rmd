...
Question: How many neighboring events within one month each event has (+-15 days)? 
...
c. Compute the statistic of relevance, e.g. linear regression coefficient or averages.
