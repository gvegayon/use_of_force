...
candidates_alt <- find_candidates(
  features = x[, c("officerid", "mult_officers")],
  upper    = c(0,0),
  lower    = c(0,0),
  as_abs   = c(TRUE, TRUE) 
)
...
reports$has_permutations <- sapply(candidates_alt, length) > 0
```
